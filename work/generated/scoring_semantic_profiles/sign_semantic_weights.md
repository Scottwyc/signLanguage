...
- 语义相位 DTW：`enabled=True`, `local_phase_weight=0.018`, `anchor_penalty_weight=0.100`
- 组权重：
  - `left_hand`: `0.2000`
  - `right_hand`: `0.2000`
...
- 语义相位 DTW：`enabled=True`, `local_phase_weight=0.020`, `anchor_penalty_weight=0.110`
- 组权重：
  - `left_hand`: `0.0800`
  - `right_hand`: `0.3400`
  - `left_hand_shape`: `0.1000`
...
- 语义相位 DTW：`enabled=True`, `local_phase_weight=0.016`, `anchor_penalty_weight=0.090`
- 组权重：
  - `left_hand`: `0.2136`
  - `right_hand`: `0.2991`
