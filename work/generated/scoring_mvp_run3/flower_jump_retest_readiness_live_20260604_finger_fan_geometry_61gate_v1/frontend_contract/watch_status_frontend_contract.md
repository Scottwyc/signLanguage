...
- generated_at: `2026-06-04T02:22:18`
- status: **PASS**
...
- generated_at: `2026-06-04T02:22:04`
- watcher_pid: `1680520`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T02:22:04 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1680520 |
