...
- generated_at: `2026-06-04T10:55:54`
- status: **PASS**
...
- generated_at: `2026-06-04T10:55:34`
- watcher_pid: `4015987`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T10:55:34 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=4015987 |
