...
- generated_at: `2026-06-03T21:19:12`
- status: **PASS**
...
- generated_at: `2026-06-03T21:18:57`
- watcher_pid: `139028`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T21:18:57 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=139028 |
