...
- 均分：`64.534`
- 中位数：`77.612`
- 分段计数：`{'low': 30, 'normal_like': 94, 'borderline': 21}`
- 诊断计数：`{'flower_low_other': 2, 'flower_core_accepted': 80, 'flower_core_hand_presence_low': 5, 'flower_opening_guard_failed': 4, 'jump_core_accepted': 35, 'jump_two_hand_presence_low': 19}`
- 采集质量计数：`{'score_valid': 117, 'needs_recapture': 25, 'semantic_mismatch': 3}`
- 有效采集口径：可评分样本 `120`，正常+边界 `115`，低分 `5`，正常+边界率 `95.8%`。

## 分词条

| 词条 | 样本数 | 正常 | 边界 | 低分 | 均分 | 中位数 | 最低 | 最高 | 核心覆盖均值 | L/R 覆盖均值 | 采集质量 | 主要诊断 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 花 | 91 | 74 | 6 | 11 | 72.578 | 78.401 | 4.202 | 80.784 | 0.704 | 0.017/0.698 | score_valid:82, needs_recapture:6, semantic_mismatch:3 | flower_core_accepted:80, flower_core_hand_presence_low:5, flower_opening_guard_failed:4 |
| 跳 | 54 | 20 | 15 | 19 | 50.979 | 71.809 | 0.833 | 84.974 | 0.691 | 0.608/0.720 | score_valid:35, needs_recapture:19 | jump_core_accepted:35, jump_two_hand_presence_low:19 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 花 | 91 | 6 | 85 | 80 | 5 | 94.1% | 75.583 | 3 |
| 跳 | 54 | 19 | 35 | 35 | 0 | 100.0% | 76.509 | 0 |
...
|---|---|---:|---|---|---:|---:|---:|---:|---:|
| web_20260523_062341_afa8c368 | 花 | 14.572 | flower_opening_guard_failed | - | - | - | - | - | - |
| web_20260522_232244_45d260ed | 花 | 48.531 | flower_opening_guard_failed | - | - | - | - | - | - |
| web_20260523_031345_3b07a113 | 花 | 54.425 | flower_opening_guard_failed | - | - | - | - | - | - |

## 跳语义 floor 接收明细

- `action_window_net` 表示动作窗口起止净方向直接通过；`full_sequence_local_relation_segment` 表示完整序列中检测到局部双手弹跳段，并通过右手食指/中指手形守卫。
- 来源分布：`{'full_sequence_local_relation_segment': 7, 'action_window_net': 28}`
...
- 低分数：`11`
- 诊断分布：`{'flower_low_other': 2, 'flower_core_hand_presence_low': 5, 'flower_opening_guard_failed': 4}`

| request | 分数 | 采集质量 | 诊断 | floor 原因 | L/R 覆盖 | 花-张开 | 双手关系 | 右手形 |
|---|---:|---|---|---|---:|---:|---:|---:|
| web_20260522_231259_51a8c719 | 4.202 | needs_recapture | flower_core_hand_presence_low | - | 0.000/0.500 | 0.450 | 0.000 | 0.000 |
| web_20260522_225823_46498d30 | 13.248 | needs_recapture | flower_core_hand_presence_low | - | 0.000/0.467 | 1.000 | 0.000 | 0.000 |
...
| web_20260523_005246_dbadcd43 | 30.754 | score_valid | flower_low_other | - | 0.000/0.636 | 0.750 | 0.000 | 0.000 |
| web_20260602_213030_368950ee | 44.503 | needs_recapture | flower_core_hand_presence_low | - | 0.040/0.480 | 1.000 | 0.000 | 0.004 |
| web_20260522_232244_45d260ed | 48.531 | semantic_mismatch | flower_opening_guard_failed | - | 0.000/0.633 | 0.122 | 0.000 | 0.000 |
| web_20260523_032325_7e7b2476 | 51.245 | needs_recapture | flower_core_hand_presence_low | - | 0.000/0.500 | 1.000 | 0.000 | 0.000 |
| web_20260522_222243_a23d679c | 51.557 | score_valid | flower_low_other | - | 0.000/0.750 | 0.629 | 0.000 | 0.000 |
