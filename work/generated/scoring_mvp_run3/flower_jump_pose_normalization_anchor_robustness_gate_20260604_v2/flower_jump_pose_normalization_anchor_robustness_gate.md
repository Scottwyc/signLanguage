...
| vertical_shoulder_shift_sparse_interpolated | PASS | 98.760 | 75.000 | True | 16 | score_valid:score_valid | 稀疏肩部整体漂移应由可信相邻帧插值。 |
...
| vertical_shoulder_shift_sparse_interpolated | PASS | 76.227 | 75.000 | True | 6 | score_valid:score_valid | 稀疏肩部整体漂移应由可信相邻帧插值。 |
