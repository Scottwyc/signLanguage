...
|---|---|---:|---|---:|---|---:|
| 花 | FAIL | 23.733 | hand_z_noise_0.10 | 13.117 | hand_z_noise_0.20_diagnostic | 70.000 |
| 跳 | FAIL | 30.536 | hand_z_noise_0.10 | 70.469 | global_z_noise_0.20_diagnostic | 70.000 |
...
| hand_z_noise_0.10 | positive | FAIL | 23.733 | >= 70.0 | 0.172598 | full_sequence_with_action_window_diagnostics | score_valid | short_visible_core | 中等手部 z 噪声，并重算手形特征。 |
| global_z_noise_0.10 | positive | FAIL | 24.158 | >= 70.0 | 0.170467 | full_sequence_with_action_window_diagnostics | score_valid | short_visible_core | 中等整体 z 噪声，模拟深度估计抖动。 |
...
| hand_z_noise_0.10 | positive | FAIL | 30.536 | >= 70.0 | 0.201315 | semantic_action_window | semantic_mismatch | action_window_net | 中等手部 z 噪声，并重算手形特征。 |
...
| global_z_noise_0.10 | positive | PASS | 82.302 | >= 70.0 | 0.163525 | semantic_action_window | score_valid | action_window_net | 中等整体 z 噪声，模拟深度估计抖动。 |
