...
- generated_at: `2026-06-03T15:37:32`
- status: **PASS**
...
- generated_at: `2026-06-03T15:37:14`
- watcher_pid: `2852363`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T15:37:14 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=2852363 |
