...
- generated_at: `2026-06-04T01:31:51`
- status: **PASS**
...
- generated_at: `2026-06-04T01:31:43`
- watcher_pid: `1495416`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T01:31:43 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1495416 |
