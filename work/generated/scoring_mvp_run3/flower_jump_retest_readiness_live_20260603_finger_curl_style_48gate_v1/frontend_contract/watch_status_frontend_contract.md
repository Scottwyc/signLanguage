...
- generated_at: `2026-06-03T23:36:06`
- status: **PASS**
...
- generated_at: `2026-06-03T23:36:04`
- watcher_pid: `899012`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T23:36:04 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=899012 |
