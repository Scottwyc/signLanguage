...
|---|---|---:|---|---:|
| 花 | FAIL | 100.000 | self_reloaded | 70.000 |
| 跳 | FAIL | 100.000 | self_reloaded | 70.000 |
...
|---|---|---|---:|---:|---:|---:|---|---|---|---|---|
| bbox_combined_temporal_metadata_finite | bbox | FAIL | - | finite-only | - | - | --- | nonfinite=-, negative=- | no | no | 旧 bbox 兼容模式遇到组合时间元数据损坏时应保持有限评分，不强求缺少指尖语义的 bbox 得到高分。 |
