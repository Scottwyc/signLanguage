...
- generated_at: `2026-06-03T05:32:23`
- status: **PASS**
...
- generated_at: `2026-06-03T05:32:05`
- watcher_pid: `3856536`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T05:32:05 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=3856536 |
...
| `watch_status_fresh` | PASS | `fail` | age_sec=18.3, max_age_sec=180.0 |
