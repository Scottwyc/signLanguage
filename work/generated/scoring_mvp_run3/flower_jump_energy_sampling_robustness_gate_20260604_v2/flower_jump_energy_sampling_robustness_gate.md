...
| top_energy_with_endpoints_16f | positive | FAIL | 26.639 | >= 70.0 | 16 | 1.000 | full_sequence_with_action_window_diagnostics | semantic_mismatch | phase_order_disorder | 高运动帧占比更高，但保留动作起止端点。 |
...
| top_energy_with_endpoints_8f | positive | PASS | 80.525 | >= 70.0 | 8 | 1.000 | semantic_action_window | score_valid | score_valid | 高运动帧占比更高，但保留动作起止端点。 |
