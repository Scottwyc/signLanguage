...
- 采集质量计数：`{'score_valid': 125, 'semantic_mismatch': 4, 'needs_recapture': 20}`
- 有效采集口径：可评分样本 `129`，正常+边界 `124`，低分 `5`，正常+边界率 `96.1%`。

## 分词条

| 词条 | 样本数 | 正常 | 边界 | 低分 | 均分 | 中位数 | 最低 | 最高 | 核心覆盖均值 | L/R 覆盖均值 | 采集质量 | 主要诊断 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 花 | 93 | 81 | 6 | 6 | 74.513 | 78.463 | 2.913 | 80.784 | 0.943 | 0.016/0.702 | score_valid:88, semantic_mismatch:4, needs_recapture:1 | flower_core_accepted:87, flower_opening_guard_failed:5, flower_core_hand_presence_low:1 |
| 跳 | 56 | 21 | 16 | 19 | 52.002 | 71.809 | 0.833 | 88.577 | 0.717 | 0.617/0.728 | score_valid:37, needs_recapture:19 | jump_core_accepted:37, jump_two_hand_presence_low:19 |
...
| web_20260522_231259_51a8c719 | 20.468 | score_valid | flower_core_hand_presence_low | opening_guard_too_weak | 0.000/0.500 | 0.450 | 0.000 | 0.000 |
...
| web_20260523_071306_071a2172 | 花 | 15 | 76.923 | normal_like | score_valid | flower_core_accepted | 0.067/0.600 | full_sequence_with_action_window_diagnostics |
...
| web_20260602_213030_368950ee | 花 | 25 | 78.355 | normal_like | score_valid | flower_core_accepted | 0.040/0.480 | full_sequence_with_action_window_diagnostics |
