...
| 子门 | 状态 | 返回码 | 报告 |
|---|---|---:|---|
| web_regression | FAIL | 1 | `work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260603_v2/web_regression/flower_jump_web_regression.md` |
| discrimination_gate | PASS | 0 | `work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260603_v2/discrimination_gate/flower_jump_discrimination_gate.md` |
| pose_robustness_gate | PASS | 0 | `work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260603_v2/pose_robustness_gate/flower_jump_pose_robustness_gate.md` |
| frame_count_robustness_gate | PASS | 0 | `work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260603_v2/frame_count_robustness_gate/flower_jump_frame_count_robustness_gate.md` |

## 网页保存样本回归

- replay 样本 `168`，错误 `0`；花/跳 diagnostics `149`，错误 `0`。
- 有效采集 `129`，有效正常+边界 `124`，有效低分 `5`，有效正常+边界率 `96.1%`。

| 词条 | 有效采集 | 正常+边界 | 有效低分 | 有效率 | 有效均分 |
|---|---:|---:|---:|---:|---:|
| 花 | 92 | 87 | 5 | 94.6% | 75.161 |
