...
- generated_at: `2026-06-04T02:23:14`
- status: **PASS**
...
- generated_at: `2026-06-04T02:23:00`
- watcher_pid: `1739705`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T02:23:00 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1739705 |
