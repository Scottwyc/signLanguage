...
- generated_at: `2026-06-04T06:23:57`
- status: **PASS**
...
- generated_at: `2026-06-04T06:23:55`
- watcher_pid: `2601292`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T06:23:55 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=2601292 |
