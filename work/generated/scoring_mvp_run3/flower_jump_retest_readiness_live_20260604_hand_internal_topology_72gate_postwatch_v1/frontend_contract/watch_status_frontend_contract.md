...
- generated_at: `2026-06-04T16:33:20`
- status: **PASS**
...
- generated_at: `2026-06-04T16:33:02`
- watcher_pid: `1378389`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T16:33:02 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1378389 |
