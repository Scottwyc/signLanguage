...
- generated_at: `2026-06-04T00:52:45`
- status: **PASS**
...
- generated_at: `2026-06-04T00:52:30`
- watcher_pid: `1252897`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T00:52:30 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1252897 |
