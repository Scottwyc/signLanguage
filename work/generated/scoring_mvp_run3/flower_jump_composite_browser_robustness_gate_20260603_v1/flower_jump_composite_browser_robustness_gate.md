...
|---|---|---:|---|---:|---|
| 花 | FAIL | 69.012 | combo_aspect_lowres_rate | 80.313 | diagnostic_strong_browser_stack |
...
|---|---|---|---:|---|---|---|---|---|
| combo_aspect_lowres_rate | positive | FAIL | 69.012 | >= 70.0 | 53 / 1.00 | score_valid:score_valid | short_visible_core:query_not_short_core_capture | 轻微宽高比失真、低分辨率坐标取整和轻微采样间隔不均叠加。 |
...
| 变体 | 类型 | 状态 | 分数 | 阈值 | 帧数/比例 | quality | floor | 说明 |
|---|---|---|---:|---|---|---|---|---|
| combo_aspect_lowres_rate | positive | PASS | 95.357 | >= 70.0 | 19 / 1.00 | score_valid:score_valid | action_window_net:used | 轻微宽高比失真、低分辨率坐标取整和轻微采样间隔不均叠加。 |
