...
|---|---|---:|---|---:|---|---:|
| 花 | PASS | 75.998 | pose_face_sparse_nan_inf | 78.039 | all_pose_full_nan_diagnostic | 70.000 |
...
| pose_face_sparse_nan_inf | positive | PASS | 75.998 | >= 70.0 | True | 0/0 | 63 | sparse_every_7f | score_valid:score_valid | short_visible_core:query_not_short_core_capture | - | 非核心 pose/face 稀疏坏点应被当作缺失，不应污染手部语义评分。 |
...
| pose_face_sparse_nan_inf | positive | PASS | 76.256 | >= 70.0 | True | 0/0 | 27 | sparse_every_7f | score_valid:score_valid | full_sequence_local_relation_segment:used | - | 非核心 pose/face 稀疏坏点应被当作缺失，不应污染手部语义评分。 |
