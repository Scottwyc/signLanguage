...
| static_hold_end | negative | PASS | 21.721 | <= 45.0 或重采/语义失败 | 1.000 | semantic_mismatch | phase_endpoint_order_mismatch | 只有结束静止姿态，缺少完整动作过程。 |
| static_hold_mid | negative | PASS | 31.418 | <= 45.0 或重采/语义失败 | 1.000 | semantic_mismatch | phase_endpoint_order_mismatch | 只有中间静止姿态，缺少起止动态。 |
