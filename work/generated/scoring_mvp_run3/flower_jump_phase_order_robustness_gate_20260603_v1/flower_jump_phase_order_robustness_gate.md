...
|---|---|---:|---|---:|---|
| 花 | FAIL | 79.410 | ordered_jitter | 55.475 | scramble_three_phases |
| 跳 | FAIL | 69.389 | ordered_jitter | 72.027 | scramble_three_phases |
...
|---|---|---|---:|---|---:|---|---|---|
| reverse_full | negative | PASS | 20.405 | <= 50.0 或重采/语义失败 | 1.000 | score_valid | score_valid | 完整倒放，动作语义起终点和方向相反。 |
| swap_halves | negative | PASS | 48.880 | <= 50.0 或重采/语义失败 | 1.000 | score_valid | score_valid | 前后半段错序，语义相位不连续。 |
| scramble_three_phases | negative | FAIL | 55.475 | <= 50.0 或重采/语义失败 | 1.000 | score_valid | score_valid | 结束、中段、开始三相位乱序。 |
...
| 变体 | 类型 | 状态 | 分数 | 阈值 | 长度比 | capture_quality | reason | 说明 |
|---|---|---|---:|---|---:|---|---|---|
| reverse_full | negative | PASS | 20.525 | <= 50.0 或重采/语义失败 | 1.000 | semantic_mismatch | relation_direction_mismatch | 完整倒放，动作语义起终点和方向相反。 |
| swap_halves | negative | PASS | 47.277 | <= 50.0 或重采/语义失败 | 1.000 | semantic_mismatch | weak_same_direction_vertical_jump | 前后半段错序，语义相位不连续。 |
| scramble_three_phases | negative | FAIL | 72.027 | <= 50.0 或重采/语义失败 | 1.000 | score_valid | score_valid | 结束、中段、开始三相位乱序。 |
