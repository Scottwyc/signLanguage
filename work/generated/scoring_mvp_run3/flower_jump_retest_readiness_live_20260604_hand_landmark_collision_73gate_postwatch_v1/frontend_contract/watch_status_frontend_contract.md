...
- generated_at: `2026-06-04T17:39:19`
- status: **PASS**
...
- generated_at: `2026-06-04T17:39:01`
- watcher_pid: `1678764`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T17:39:01 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1678764 |
