...
- generated_at: `2026-06-04T10:02:35`
- status: **PASS**
...
- generated_at: `2026-06-04T10:02:34`
- watcher_pid: `3792390`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T10:02:34 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=3792390 |
