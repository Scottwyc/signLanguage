...
| 项 | 状态 | 细节 |
|---|---|---|
| 5080/Holistic | `PASS` | worker=`ready`，pid=`811485`，reload_count=`23`，last_reload_error=`None` |
| watcher | `PASS` | event=`no_target_samples`，pid=`3792390`，target_count=`0` |
| 前端契约 | `PASS` | failed=`0`，warning=`3` |
| 综合质量门 | `PASS` | 报告 `work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260604_sanitized_temporal_metadata_bbox_67gate_v2/flower_jump_quality_gate.md` |
| 浏览器证据门 | `PASS` | 报告 `work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_sanitized_temporal_metadata_bbox_67gate_postwatch_v2/browser_evidence_gate/flower_jump_browser_evidence_gate.md` |
| 网页上传权重语义 | `PASS` | checks=`8`，failed=`-` |
| 网页上传权重仿真 | `PASS` | cases=`3`，报告 `work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_sanitized_temporal_metadata_bbox_67gate_postwatch_v2/browser_upload_weight_simulation_gate/browser_upload_weight_simulation_gate.md` |
...
|---|---:|---|---:|---|
| 花 | 77.581 | pose_face_sparse_nan_inf | 23.221 | all_pose_full_nan_diagnostic |
| 跳 | 70.714 | jump_right_person_tip_single_nan | 8.288 | all_pose_full_nan_diagnostic |
...
- 完成度审计：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_sanitized_temporal_metadata_bbox_67gate_postwatch_v2/goal_readiness/flower_jump_goal_readiness_audit.md`
- 前端契约：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_sanitized_temporal_metadata_bbox_67gate_postwatch_v2/frontend_contract/watch_status_frontend_contract.md`
- 浏览器证据门：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_sanitized_temporal_metadata_bbox_67gate_postwatch_v2/browser_evidence_gate/flower_jump_browser_evidence_gate.md`
- 网页上传权重仿真：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_sanitized_temporal_metadata_bbox_67gate_postwatch_v2/browser_upload_weight_simulation_gate/browser_upload_weight_simulation_gate.md`
- 综合质量门：`work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260604_sanitized_temporal_metadata_bbox_67gate_v2/flower_jump_quality_gate.md`
