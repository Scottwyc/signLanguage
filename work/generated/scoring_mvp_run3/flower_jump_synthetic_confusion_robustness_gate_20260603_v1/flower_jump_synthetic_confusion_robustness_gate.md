...
| 跳 | 花 | framing | framing_shift_zoom_out | PASS | 70.708 | 15.040 | 55.668 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | landmark_noise | hand_noise_0.010_seed1 | PASS | 72.810 | 14.959 | 57.852 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | mirror | mirror_x | PASS | 80.843 | 14.532 | 66.311 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | temporal_padding | slow_repeat_each_2x | PASS | 79.124 | 12.146 | 66.978 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | action_crop | trim_start_15pct | PASS | 80.750 | 11.428 | 69.322 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | landmark_noise | hand_frame_dropout_0.03_seed1 | PASS | 89.463 | 16.074 | 73.388 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | temporal_padding | prefix_hold_25pct | PASS | 100.000 | 25.551 | 74.449 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | action_crop | center_70pct | PASS | 81.045 | 5.000 | 76.045 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | framing | global_rotate_8deg | PASS | 95.788 | 15.247 | 80.541 | score_valid | semantic_mismatch | passed |
| 跳 | 花 | baseline | self_recomputed | PASS | 100.000 | 15.090 | 84.910 | score_valid | semantic_mismatch | passed |
