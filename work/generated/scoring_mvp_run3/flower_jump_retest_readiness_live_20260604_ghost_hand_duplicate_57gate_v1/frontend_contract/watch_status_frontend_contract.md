...
- generated_at: `2026-06-04T01:30:59`
- status: **PASS**
...
- generated_at: `2026-06-04T01:30:42`
- watcher_pid: `1422559`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T01:30:42 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1422559 |
