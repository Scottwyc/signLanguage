...
- 生成时间：`2026-06-02T21:55:38`
- 样本数：`54`
- 口径：逐条使用网页样本保存的 `standard_json` 和 `query_json`，用当前评分模块复算，不重新运行 Holistic。
...
| web_20260523_010014_049faf7d | 1.070 | two_hand_presence_low | insufficient_two_hand_presence | 1.00/0.33 | 0.124/0.179 | 0.139 |
| web_20260523_001113_b486eb41 | 1.239 | two_hand_presence_low | insufficient_two_hand_presence | 0.00/1.00 | 0.147/0.286 | 0.000 |
| web_20260523_005953_cdf0697d | 1.346 | two_hand_presence_low | insufficient_two_hand_presence | 1.00/0.33 | 0.113/0.178 | 0.101 |
...
| web_20260523_011135_5967dd5a | 3.176 | two_hand_presence_low | insufficient_two_hand_presence | 0.50/0.88 | 0.231/0.289 | 0.497 |
...
| web_20260523_001100_dea381ee | 3.844 | two_hand_presence_low | insufficient_two_hand_presence | 0.50/1.00 | 0.183/0.282 | 0.407 |
...
| web_20260523_024037_ff5b3fb5 | 6.227 | two_hand_presence_low | insufficient_two_hand_presence | 0.50/1.00 | 0.214/0.273 | 0.265 |
