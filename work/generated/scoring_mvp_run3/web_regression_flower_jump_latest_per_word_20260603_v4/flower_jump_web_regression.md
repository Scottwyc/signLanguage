...
- 目标词：`花, 跳`
- 样本过滤：latest=`0`，latest_per_word=`1`，since_request_id=``，request_ids=`web_20260602_233343_899e6970, web_20260602_233348_53e3df5d`
...
- 回归状态：`PASS`
- replay 报告：`work/generated/scoring_mvp_run3/web_regression_flower_jump_latest_per_word_20260603_v4/active_template_replay/web_replay_current.md`
- diagnostics 报告：`work/generated/scoring_mvp_run3/web_regression_flower_jump_latest_per_word_20260603_v4/flower_jump_diagnostics/web_semantic_diagnostics.md`
...
- 目标词样本 `2`，错误 `0`，有效采集 `2`，有效正常+边界 `2`，有效低分 `0`，有效正常+边界率 `100.0%`。
