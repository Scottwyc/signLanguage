...
|---|---:|---:|---:|---:|---:|---:|---:|
| 汽车 | 3 | 0 | 0 | 3 | 4.487 | 6.892 | 0.833 |
| 花 | 71 | 7 | 0 | 64 | 44.759 | 28.025 | 0.711 |
| 虎 | 2 | 0 | 0 | 2 | 17.753 | 8.978 | 0.780 |
| 跳 | 47 | 8 | 0 | 39 | 22.632 | 19.076 | 0.755 |
| 香蕉 | 11 | 0 | 0 | 11 | 14.152 | 5.883 | 0.576 |

## 最新样本

| request | 词条 | 帧数 | 旧分 | 新分 | 分段 | 手部覆盖 | 对齐 |
|---|---|---:|---:|---:|---|---:|---|
| web_20260523_052801_95c97bce | 花 | 30 | 51.733 | 27.450 | low | 0.567 | full_sequence_with_action_window_diagnostics |
| web_20260523_052817_7ae13ce2 | 花 | 25 | 55.699 | 22.211 | low | 0.680 | full_sequence_with_action_window_diagnostics |
| web_20260523_053035_073e5794 | 花 | 25 | 66.556 | 21.842 | low | 0.680 | full_sequence_with_action_window_diagnostics |
| web_20260523_053051_a785c84e | 花 | 25 | 45.462 | 20.121 | low | 0.640 | full_sequence_with_action_window_diagnostics |
| web_20260523_053102_e1ff4324 | 花 | 25 | 61.827 | 25.656 | low | 0.720 | full_sequence_with_action_window_diagnostics |
| web_20260523_053116_49159767 | 花 | 25 | 70.327 | 27.614 | low | 0.800 | full_sequence_with_action_window_diagnostics |
| web_20260523_053128_81d821bf | 花 | 25 | 66.174 | 26.247 | low | 0.680 | full_sequence_with_action_window_diagnostics |
| web_20260523_053203_4ec1e6ab | 花 | 25 | 63.884 | 21.360 | low | 0.680 | full_sequence_with_action_window_diagnostics |
...
| web_20260523_054426_114ad88f | 虎 | 25 | 13.139 | 6.960 | low | 0.960 | full_sequence_with_action_window_diagnostics |
| web_20260523_054448_4f0ebbd6 | 虎 | 25 | 22.367 | 10.995 | low | 0.600 | full_sequence_with_action_window_diagnostics |
| web_20260523_054508_865bd606 | 香蕉 | 25 | 17.227 | 8.503 | low | 0.800 | full_sequence_with_action_window_diagnostics |
| web_20260523_054643_16ed6eb8 | 汽车 | 25 | 6.080 | 7.471 | low | 0.800 | full_sequence_with_action_window_diagnostics |
| web_20260523_054658_9edec32b | 汽车 | 20 | 3.969 | 5.198 | low | 0.850 | full_sequence_with_action_window_diagnostics |
| web_20260523_054709_566e6021 | 汽车 | 20 | 3.413 | 8.006 | low | 0.850 | full_sequence_with_action_window_diagnostics |
...
- `web_20260523_010145_82035a51` / 香蕉: score=`1.788`, frames=`30`, hand_presence=`0.633`, mode=`semantic_action_window`
...
- `web_20260523_001229_690e6b5a` / 香蕉: score=`2.701`, frames=`30`, hand_presence=`0.700`, mode=`semantic_action_window`
- `web_20260523_010119_d0158d2a` / 香蕉: score=`2.748`, frames=`30`, hand_presence=`0.467`, mode=`semantic_action_window`
- `web_20260523_001204_d3564a22` / 香蕉: score=`2.974`, frames=`15`, hand_presence=`0.067`, mode=`semantic_action_window`
...
- `web_20260523_001241_e882a59e` / 香蕉: score=`3.674`, frames=`30`, hand_presence=`0.533`, mode=`semantic_action_window`
