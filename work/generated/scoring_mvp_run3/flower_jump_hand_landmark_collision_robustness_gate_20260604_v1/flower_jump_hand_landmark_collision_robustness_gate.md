...
- 生成时间：`2026-06-04T16:48:11`
- 标准库：`/data/WYC/signLanguage/work/generated/scoring_mvp_run3/all_demo_step2_worker_cache_semantic_v1/results`
- 碰撞边界：三维距离 `<= 1e-05` 的参与点按歧义点局部屏蔽。
- 正常证据审计：`178` 个模板/网页 JSON、`4750` 个非空手帧，原始碰撞帧 `0`，最小正常点间距 `0.00014560438285116106`。
- 量化兼容审计：`{'camera_640x480_z1024': {'collision_frame_count': 105, 'max_collision_participant_count': 8, 'max_collision_cluster_size': 3, 'local_mask_violation_count': 0}, 'camera_320x240_z512': {'collision_frame_count': 444, 'max_collision_participant_count': 13, 'max_collision_cluster_size': 4, 'local_mask_violation_count': 0}, 'xyz_1_256': {'collision_frame_count': 689, 'max_collision_participant_count': 15, 'max_collision_cluster_size': 4, 'local_mask_violation_count': 0}}`。
...
|---|---|---:|---|---:|---|
| 花 | FAIL | 77.947 | right_hand_landmarks_xyz_1_256_raw_quantized | 80.961 | right_hand_landmarks_index_middle_to_index_mcp_full_semantic_mismatch |
| 跳 | FAIL | 6.762 | left_hand_landmarks_distal_to_mcp_all_full_noncore_preserved | 4.589 | right_hand_landmarks_index_middle_to_index_mcp_full_semantic_mismatch |
...
| right_hand_landmarks_index_middle_to_index_mcp_full_semantic_mismatch | diagnostic | FAIL | 80.961 | 55.000 | 40 | 8-8 | 8 | 1.000 | 13 | score_valid:score_valid |
...
| right_hand_landmarks_single_index_tip_to_dip_sparse_preserved | positive | PASS | 99.484 | 75.000 | 6 | 2-2 | 2 | 1.000 | 19 | score_valid:score_valid |
| right_hand_landmarks_camera_640x480_z1024_raw_quantized | positive | PASS | 80.675 | 70.000 | 1 | 0-4 | 2 | 1.000 | 17 | score_valid:score_valid |
| right_hand_landmarks_camera_320x240_z512_raw_quantized | positive | PASS | 78.838 | 70.000 | 5 | 0-7 | 3 | 1.000 | 14 | score_valid:score_valid |
| right_hand_landmarks_xyz_1_256_raw_quantized | positive | PASS | 77.947 | 70.000 | 7 | 0-11 | 3 | 1.000 | 10 | score_valid:score_valid |
...
| right_hand_landmarks_single_index_tip_to_dip_sparse_preserved | positive | FAIL | 70.714 | 75.000 | 2 | 2-2 | 2 | 1.000 | 19 | score_valid:score_valid |
| right_hand_landmarks_camera_640x480_z1024_raw_quantized | positive | PASS | 74.385 | 70.000 | 1 | 0-2 | 2 | 1.000 | 19 | score_valid:score_valid |
| right_hand_landmarks_camera_320x240_z512_raw_quantized | positive | PASS | 84.660 | 70.000 | 9 | 0-2 | 2 | 1.000 | 19 | score_valid:score_valid |
| right_hand_landmarks_xyz_1_256_raw_quantized | positive | PASS | 74.600 | 70.000 | 10 | 0-6 | 2 | 1.000 | 15 | score_valid:score_valid |
...
| left_hand_landmarks_distal_to_mcp_all_full_noncore_preserved | positive | FAIL | 6.762 | 75.000 | 16 | 20-20 | 4 | 1.000 | 1 | semantic_mismatch:missing_relation_delta |
...
| left_hand_landmarks_index_middle_to_index_mcp_full_noncore_preserved | positive | FAIL | 9.307 | 75.000 | 16 | 8-8 | 8 | 1.000 | 13 | semantic_mismatch:missing_relation_delta |
...
| left_hand_landmarks_single_index_tip_to_dip_sparse_preserved | positive | PASS | 99.436 | 75.000 | 2 | 2-2 | 2 | 1.000 | 19 | score_valid:score_valid |
| left_hand_landmarks_camera_640x480_z1024_raw_quantized | positive | PASS | 70.614 | 70.000 | 2 | 0-2 | 2 | 1.000 | 19 | score_valid:score_valid |
| left_hand_landmarks_camera_320x240_z512_raw_quantized | positive | PASS | 81.517 | 70.000 | 12 | 0-11 | 3 | 1.000 | 10 | score_valid:score_valid |
| left_hand_landmarks_xyz_1_256_raw_quantized | positive | FAIL | 9.278 | 70.000 | 15 | 0-13 | 3 | 1.000 | 8 | semantic_mismatch:missing_relation_delta |

## 说明

- 只屏蔽碰撞参与点；不能按碰撞参与点总数丢弃整手，因为合理坐标量化也会产生多个重复点。
- 正常原始证据零碰撞是硬门；量化审计同时验证局部屏蔽不会扩大到非碰撞点。
