...
|---|---|---|---:|---|---|---|---|
| right_opening_outer_half_edge_clip | negative | PASS | 10.688 | <= 45.0 或重采/语义失败 | semantic_mismatch | flower_opening_guard_failed | 开花手外半部分被画面裁掉，核心手形不可靠。 |
