...
- generated_at: `2026-06-04T11:48:46`
- status: **PASS**
...
- generated_at: `2026-06-04T11:48:42`
- watcher_pid: `21753`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T11:48:42 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=21753 |
