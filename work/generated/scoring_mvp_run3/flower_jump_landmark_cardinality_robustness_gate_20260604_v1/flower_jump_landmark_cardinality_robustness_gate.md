...
|---|---|---:|---|---:|---|
| 花 | FAIL | 45.000 | pose_drop_first_sparse_masked | 1.164 | right_hand_drop_first_full_recapture |
| 跳 | PASS | 76.042 | pose_drop_first_sparse_masked | 2.161 | left_hand_drop_first_full_recapture |
...
| right_hand_drop_first_sparse_masked | positive | PASS | 97.587 | 75.000 | 8 | True | score_valid:score_valid |
| pose_drop_first_sparse_masked | positive | FAIL | 45.000 | 75.000 | 11 | True | semantic_mismatch:phase_order_disorder |
...
| right_hand_drop_middle_sparse_masked | positive | PASS | 97.587 | 75.000 | 8 | True | score_valid:score_valid |
| pose_drop_middle_sparse_masked | positive | FAIL | 45.000 | 75.000 | 11 | True | semantic_mismatch:phase_order_disorder |
...
| right_hand_insert_first_sparse_masked | positive | PASS | 97.587 | 75.000 | 8 | True | score_valid:score_valid |
| pose_insert_first_sparse_masked | positive | FAIL | 45.000 | 75.000 | 11 | True | semantic_mismatch:phase_order_disorder |
...
| right_hand_append_extra_sparse_masked | positive | PASS | 97.587 | 75.000 | 8 | True | score_valid:score_valid |
| pose_append_extra_sparse_masked | positive | FAIL | 45.000 | 75.000 | 11 | True | semantic_mismatch:phase_order_disorder |
...
| face_insert_first_sparse_masked | positive | PASS | 100.000 | 95.000 | 11 | True | score_valid:score_valid |
| face_insert_first_full_masked | positive | PASS | 100.000 | 95.000 | 53 | True | score_valid:score_valid |
| face_drop_middle_sparse_masked | positive | PASS | 100.000 | 95.000 | 11 | True | score_valid:score_valid |
...
|---|---|---|---:|---:|---:|---|---|
| self_reloaded | positive | PASS | 100.000 | 95.000 | 0 | True | score_valid:score_valid |
| right_hand_drop_first_sparse_masked | positive | PASS | 81.958 | 75.000 | 3 | True | score_valid:score_valid |
| pose_drop_first_sparse_masked | positive | PASS | 76.042 | 75.000 | 4 | True | score_valid:score_valid |
...
| right_hand_drop_middle_sparse_masked | positive | PASS | 81.958 | 75.000 | 3 | True | score_valid:score_valid |
| pose_drop_middle_sparse_masked | positive | PASS | 76.042 | 75.000 | 4 | True | score_valid:score_valid |
...
| right_hand_insert_first_sparse_masked | positive | PASS | 81.958 | 75.000 | 3 | True | score_valid:score_valid |
| pose_insert_first_sparse_masked | positive | PASS | 76.042 | 75.000 | 4 | True | score_valid:score_valid |
...
| right_hand_append_extra_sparse_masked | positive | PASS | 81.958 | 75.000 | 3 | True | score_valid:score_valid |
| pose_append_extra_sparse_masked | positive | PASS | 76.042 | 75.000 | 4 | True | score_valid:score_valid |
...
| face_insert_first_sparse_masked | positive | PASS | 100.000 | 95.000 | 4 | True | score_valid:score_valid |
| face_insert_first_full_masked | positive | PASS | 100.000 | 95.000 | 19 | True | score_valid:score_valid |
| face_drop_middle_sparse_masked | positive | PASS | 100.000 | 95.000 | 4 | True | score_valid:score_valid |
| face_drop_middle_full_masked | positive | PASS | 100.000 | 95.000 | 19 | True | score_valid:score_valid |
| left_hand_drop_first_sparse_masked | positive | PASS | 78.922 | 75.000 | 3 | True | score_valid:score_valid |
| left_hand_drop_first_full_recapture | diagnostic | PASS | 2.161 | 55.000 | 16 | True | needs_recapture:jump_two_hand_presence_low |
| left_hand_drop_middle_sparse_masked | positive | PASS | 78.922 | 75.000 | 3 | True | score_valid:score_valid |
| left_hand_drop_middle_full_recapture | diagnostic | PASS | 2.161 | 55.000 | 16 | True | needs_recapture:jump_two_hand_presence_low |
| left_hand_insert_first_sparse_masked | positive | PASS | 78.922 | 75.000 | 3 | True | score_valid:score_valid |
| left_hand_insert_first_full_recapture | diagnostic | PASS | 2.161 | 55.000 | 16 | True | needs_recapture:jump_two_hand_presence_low |
| left_hand_append_extra_sparse_masked | positive | PASS | 78.922 | 75.000 | 3 | True | score_valid:score_valid |
