...
- generated_at: `2026-06-04T00:00:03`
- status: **PASS**
...
- generated_at: `2026-06-03T23:59:46`
- watcher_pid: `998034`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T23:59:46 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=998034 |
