...
| gate | 状态 | 说明 |
|---|---|---|
| backend_ready | PASS | worker=ready, pid=811485, reload_count=12, last_reload_error=None |
| watcher_online | PASS | event=no_target_samples, watcher_pid=4021854, generated_at=2026-06-03T07:09:25 |
| marker_available | PASS | last_request_id=web_20260602_233348_53e3df5d, marker_after_new=0, target_new=0 |
| combined_quality_gate_passed | PASS | quality_gate=work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260603_phase_diagnostic_stable_v1/flower_jump_quality_gate.json, subgates=[('web_regression', True), ('web_confusion_gate', True), ('discrimination_gate', True), ('pose_robustness_gate', True), ('frame_count_robustness_gate', True), ('missing_mask_robustness_gate', True), ('temporal_padding_robustness_gate', True)] |
| fresh_real_webcam_target_samples_diagnosed | MISSING | marker_after_target_count=0, latest_diagnosis=-, browser_capture_evidence={'request_ids': [], 'passed': False, 'sample_evidence_passed': False, 'required_words': ['花', '跳'], 'observed_words': [], 'required_words_covered': False, 'missing_required_words': ['花', '跳'], 'rows': []} |

## 最新质量门摘要

- 报告：`work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260603_phase_diagnostic_stable_v1/flower_jump_quality_gate.md`
- 综合状态：`PASS`
- 子门：`web_regression`=PASS，`web_confusion_gate`=PASS，`discrimination_gate`=PASS，`pose_robustness_gate`=PASS，`frame_count_robustness_gate`=PASS，`missing_mask_robustness_gate`=PASS，`temporal_padding_robustness_gate`=PASS。
