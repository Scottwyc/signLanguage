...
- generated_at: `2026-06-03T07:09:40`
- status: **PASS**
...
- generated_at: `2026-06-03T07:09:25`
- watcher_pid: `4021854`
- target_count: `0`
- goal_status: `NOT_READY`
- missing_gates: `['combined_quality_gate_passed', 'fresh_real_webcam_target_samples_diagnosed']`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T07:09:25 |
...
| `goal_readiness_missing_gates_list` | PASS | `fail` | missing_gates=['combined_quality_gate_passed', 'fresh_real_webcam_target_samples_diagnosed'] |
