...
- 目标：1-2 帧 finger-chain latency 仍可正常评分；持续强延迟只记录诊断边界。
...
|---|---|---:|---|---:|---|---:|
| 花 | FAIL | 40.342 | flower_right_all_distal_advance_1f | 48.553 | flower_right_all_distal_delay_4f_diagnostic | 70.000 |
...
| flower_right_all_distal_advance_1f | positive | FAIL | 40.342 | >= 70.0 | right_hand | [2, 3, 4, 6, 7, 8, 10, 11, 12, 14, 15, 16, 18, 19, 20] | -1 | full | 38 | 570 | score_valid:score_valid | short_visible_core:query_not_short_core_capture | 开花核心手 distal finger joints 提前 1 帧，覆盖相反方向的帧对齐误差。 |
| flower_right_all_distal_delay_1f | positive | FAIL | 51.292 | >= 70.0 | right_hand | [2, 3, 4, 6, 7, 8, 10, 11, 12, 14, 15, 16, 18, 19, 20] | 1 | full | 38 | 570 | score_valid:score_valid | short_visible_core:query_not_short_core_capture | 开花核心手所有 distal finger joints 相对掌根滞后 1 帧，模拟快速开合时指尖追踪延迟。 |
