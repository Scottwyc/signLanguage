...
| 项 | 状态 | 细节 |
|---|---|---|
| 5080/Holistic | `PASS` | worker=`ready`，pid=`811485`，reload_count=`31`，last_reload_error=`None` |
| watcher | `PASS` | event=`no_target_samples`，pid=`1973666`，target_count=`0` |
| 前端契约 | `PASS` | failed=`0`，warning=`3` |
| 综合质量门 | `PASS` | 报告 `work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260604_hand_bone_length_integrity_74gate_v1/flower_jump_quality_gate.md` |
| 浏览器证据门 | `PASS` | 报告 `work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_hand_bone_length_integrity_74gate_postwatch_v1/browser_evidence_gate/flower_jump_browser_evidence_gate.md` |
| 网页上传权重语义 | `PASS` | checks=`8`，failed=`-` |
| 网页上传权重仿真 | `PASS` | cases=`3`，报告 `work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_hand_bone_length_integrity_74gate_postwatch_v1/browser_upload_weight_simulation_gate/browser_upload_weight_simulation_gate.md` |
...
- Hand 骨段长度正常证据审计：files=`178`，hand_frames=`4750`，segments=`71250`，violations=`0`，normal_ratio_range=`0.00709768606550895`–`1.665053336757409`。

| 词条 | 骨段正向最低分 | 最弱骨段变体 | 整段骨段损坏诊断最高分 | 最强骨段损坏 |
|---|---:|---|---:|---|
| 花 | 78.512 | right_hand_landmarks_xyz_1_256_quantized_preserved | 10.731 | right_hand_landmarks_all_distal_long_full_recapture |
...
- 完成度审计：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_hand_bone_length_integrity_74gate_postwatch_v1/goal_readiness/flower_jump_goal_readiness_audit.md`
- 前端契约：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_hand_bone_length_integrity_74gate_postwatch_v1/frontend_contract/watch_status_frontend_contract.md`
- 浏览器证据门：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_hand_bone_length_integrity_74gate_postwatch_v1/browser_evidence_gate/flower_jump_browser_evidence_gate.md`
- 网页上传权重仿真：`work/generated/scoring_mvp_run3/flower_jump_retest_readiness_live_20260604_hand_bone_length_integrity_74gate_postwatch_v1/browser_upload_weight_simulation_gate/browser_upload_weight_simulation_gate.md`
- 综合质量门：`work/generated/scoring_mvp_run3/flower_jump_quality_gate_20260604_hand_bone_length_integrity_74gate_v1/flower_jump_quality_gate.md`
