...
- generated_at: `2026-06-04T05:21:19`
- status: **PASS**
...
- generated_at: `2026-06-04T05:21:05`
- watcher_pid: `2385264`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T05:21:05 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=2385264 |
