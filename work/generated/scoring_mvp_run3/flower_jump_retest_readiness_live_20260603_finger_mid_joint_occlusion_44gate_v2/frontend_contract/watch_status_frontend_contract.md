...
- generated_at: `2026-06-03T22:48:07`
- status: **PASS**
...
- generated_at: `2026-06-03T22:47:48`
- watcher_pid: `713829`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T22:47:48 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=713829 |
