...
- generated_at: `2026-06-04T07:13:00`
- status: **PASS**
...
- generated_at: `2026-06-04T07:12:49`
- watcher_pid: `3102403`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T07:12:49 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=3102403 |
