...
- generated_at: `2026-06-04T14:13:06`
- status: **PASS**
...
- generated_at: `2026-06-04T14:12:53`
- watcher_pid: `665220`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T14:12:53 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=665220 |
