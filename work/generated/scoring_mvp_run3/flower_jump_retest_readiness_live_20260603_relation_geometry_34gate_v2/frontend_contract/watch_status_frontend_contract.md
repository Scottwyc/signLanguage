...
- generated_at: `2026-06-03T18:58:30`
- status: **PASS**
...
- generated_at: `2026-06-03T18:58:29`
- watcher_pid: `3815368`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T18:58:29 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=3815368 |
