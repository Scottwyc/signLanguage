...
- generated_at: `2026-06-05T14:40:37`
- status: **PASS**
...
- generated_at: `2026-06-04T20:42:34`
- watcher_pid: `2311546`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T20:42:34 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=2311546 |
...
| `live_score_request_schema_present` | PASS | `fail` | properties=['client_capture_id', 'client_session_id', 'client_source', 'duration_sec', 'fps', 'frame_indices', 'frame_weights', 'frames', 'target_word', 'wait_for_ready_sec'] |
...
| `live_score_request_field:client_source` | PASS | `warn` | field=client_source |
| `live_score_request_field:client_session_id` | PASS | `warn` | field=client_session_id |
| `live_score_request_field:client_capture_id` | PASS | `warn` | field=client_capture_id |
