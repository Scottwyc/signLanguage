...
- generated_at: `2026-06-04T13:15:09`
- status: **PASS**
...
- generated_at: `2026-06-04T13:15:06`
- watcher_pid: `384054`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T13:15:06 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=384054 |
