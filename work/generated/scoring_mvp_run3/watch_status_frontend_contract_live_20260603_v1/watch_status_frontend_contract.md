...
- generated_at: `2026-06-03T04:53:35`
- status: **PASS**
...
- generated_at: `2026-06-03T04:53:29`
- watcher_pid: `3731930`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T04:53:29 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=3731930 |
...
| `watch_status_fresh` | PASS | `fail` | age_sec=6.6, max_age_sec=180.0 |
