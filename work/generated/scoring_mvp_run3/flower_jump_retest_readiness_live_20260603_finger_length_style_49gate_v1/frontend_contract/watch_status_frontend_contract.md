...
- generated_at: `2026-06-03T23:47:01`
- status: **PASS**
...
- generated_at: `2026-06-03T23:46:43`
- watcher_pid: `943721`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-03T23:46:43 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=943721 |
