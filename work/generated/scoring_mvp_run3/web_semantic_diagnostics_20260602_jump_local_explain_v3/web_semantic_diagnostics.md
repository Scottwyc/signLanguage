...
- 均分：`64.544`
- 中位数：`78.082`
- 分段计数：`{'normal_like': 94, 'low': 29, 'borderline': 22}`
- 诊断计数：`{'flower_core_accepted': 81, 'flower_core_hand_presence_low': 5, 'flower_opening_guard_failed': 4, 'jump_core_accepted': 35, 'jump_two_hand_presence_low': 19, 'flower_low_other': 1}`
- 采集质量计数：`{'score_valid': 117, 'needs_recapture': 25, 'semantic_mismatch': 3}`
- 有效采集口径：可评分样本 `120`，正常+边界 `116`，低分 `4`，正常+边界率 `96.7%`。
...
| 跳 | 54 | 20 | 15 | 19 | 50.588 | 71.073 | 0.833 | 84.974 | 0.691 | 0.608/0.720 | score_valid:35, needs_recapture:19 | jump_core_accepted:35, jump_two_hand_presence_low:19 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 花 | 91 | 6 | 85 | 81 | 4 | 95.3% | 75.552 | 3 |
| 跳 | 54 | 19 | 35 | 35 | 0 | 100.0% | 76.135 | 0 |
...
| web_20260522_232244_45d260ed | 花 | 40.392 | flower_opening_guard_failed | - | - | - | - | - | - |
...
- 来源分布：`{'action_window_net': 29, 'full_sequence_local_relation_segment': 6}`
...
| web_20260523_001048_5bcb9948 | 65.902 | borderline | action_window_net | 0.634 | 0.840 | 1.170 | - | 9-12 | - | - |
...
| web_20260523_005941_0ec0ccab | 72.942 | borderline | action_window_net | 0.682 | 2.764 | 1.093 | - | 7-13 | - | - |
...
| web_20260523_010234_e2d59e5e | 78.844 | normal_like | action_window_net | 0.993 | 3.996 | 0.003 | - | 32-44 | - | - |
| web_20260523_010004_7eaf7ee3 | 81.277 | normal_like | action_window_net | 0.916 | 1.694 | 0.452 | - | 7-13 | - | - |
...
| web_20260523_011122_fb34e3e5 | 64.637 | borderline | full_sequence_local_relation_segment | 0.928 | 3.831 | 0.481 | 0.500 | 9-18 | 1.027 | relation_direction_mismatch |
...
| web_20260523_001152_83546751 | 80.850 | normal_like | full_sequence_local_relation_segment | 0.984 | 2.003 | 0.103 | 0.857 | 7-13 | 1.403 | relation_direction_mismatch |
