...
|---|---|---:|---|---:|---|---:|
| 花 | PASS | 81.220 | flower_right_nonoverlap_full_compress_0p08 | 80.268 | flower_right_full_fan_full_cross_0p66_diagnostic | 70.000 |
| 跳 | PASS | 76.629 | jump_right_person_sparse_compress_0p20_every_5f | 82.302 | jump_right_person_full_cross_0p58_diagnostic | 70.000 |
...
|---|---|---|---:|---|---|---|---:|---|---|---:|---:|---|---|---|
| flower_right_full_fan_full_cross_0p66_diagnostic | diagnostic | DIAG | 80.268 | diagnostic | right_hand | [('thumb', 'index'), ('index', 'middle'), ('middle', 'ring'), ('ring', 'pinky')] | 0.660 | cross | full | 40 | 600 | score_valid:score_valid | short_visible_core:query_not_short_core_capture | 诊断记录：全程相邻手指 distal chains 发生几何交叉时的边界分。 |
| flower_right_full_fan_middle35_compress_0p42_diagnostic | diagnostic | DIAG | 95.352 | diagnostic | right_hand | [('thumb', 'index'), ('index', 'middle'), ('middle', 'ring'), ('ring', 'pinky')] | 0.420 | compress | middle_35pct | 19 | 285 | score_valid:score_valid | short_visible_core:query_not_short_core_capture | 诊断记录：较长核心窗口全扇形指缝明显塌缩时的边界分。 |
...
| 变体 | 类型 | 状态 | 分数 | 阈值 | group | pairs | alpha | mode | pattern | 改动帧 | 改动点 | capture_quality | semantic_floor | 说明 |
|---|---|---|---:|---|---|---|---:|---|---|---:|---:|---|---|---|
| jump_right_person_full_cross_0p58_diagnostic | diagnostic | DIAG | 82.302 | diagnostic | right_hand | [('index', 'middle')] | 0.580 | cross | full | 17 | 102 | score_valid:score_valid | action_window_net:used | 诊断记录：右手两指小人 index/middle distal chains 全程几何交叉时的边界分。 |
| jump_right_person_middle35_compress_0p38_diagnostic | diagnostic | DIAG | 89.298 | diagnostic | right_hand | [('index', 'middle')] | 0.380 | compress | middle_35pct | 7 | 42 | score_valid:score_valid | action_window_net:used | 诊断记录：右手两指小人较长核心窗口明显指缝塌缩时的边界分。 |
