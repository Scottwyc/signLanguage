...
- generated_at: `2026-06-04T09:10:50`
- status: **PASS**
...
- generated_at: `2026-06-04T09:10:36`
- watcher_pid: `3588275`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T09:10:36 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=3588275 |
