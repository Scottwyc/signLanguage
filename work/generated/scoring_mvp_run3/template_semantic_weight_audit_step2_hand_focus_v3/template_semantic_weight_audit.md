...
| 花 | 53 | 花 | right_hand_shape,right_hand | 1.656 | 2.054 | ok | - |
...
- rank 1: frame `38`, t=`1.290s`, weight=`1.656`
- rank 2: frame `48`, t=`1.630s`, weight=`1.564`
- rank 3: frame `40`, t=`1.358s`, weight=`1.559`
- rank 4: frame `46`, t=`1.562s`, weight=`1.542`
- rank 5: frame `36`, t=`1.222s`, weight=`1.537`
- rank 6: frame `32`, t=`1.087s`, weight=`1.489`
