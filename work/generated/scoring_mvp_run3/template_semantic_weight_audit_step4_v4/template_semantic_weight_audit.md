...
| 花 | 28 | 花 | right_hand_shape,right_hand | 1.458 | 1.975 | ok | - |
...
- rank 1: frame `36`, t=`1.222s`, weight=`1.458`
- rank 2: frame `40`, t=`1.358s`, weight=`1.392`
- rank 3: frame `32`, t=`1.087s`, weight=`1.388`
- rank 4: frame `56`, t=`1.902s`, weight=`1.321`
- rank 5: frame `44`, t=`1.494s`, weight=`1.270`
- rank 6: frame `52`, t=`1.766s`, weight=`1.240`
