...
| 花 | `swap_labels_diagnostic` | `diagnostic` | PASS | 0.919 | 0.563 | score_valid / score_valid | short_visible_core / query_not_short_core_capture |
| 花 | `mirror_x_swap_labels_diagnostic` | `diagnostic` | PASS | 0.919 | 0.563 | score_valid / score_valid | short_visible_core / query_not_short_core_capture |
