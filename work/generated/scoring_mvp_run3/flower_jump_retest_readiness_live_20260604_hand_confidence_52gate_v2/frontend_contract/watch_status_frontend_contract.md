...
- generated_at: `2026-06-04T00:25:10`
- status: **PASS**
...
- generated_at: `2026-06-04T00:24:54`
- watcher_pid: `1174266`
- target_count: `0`
...
| `watch_status_generated_at` | PASS | `fail` | 2026-06-04T00:24:54 |
| `watch_status_event_known` | PASS | `fail` | no_target_samples |
| `watcher_pid_present` | PASS | `fail` | watcher_pid=1174266 |
