...
- subsample_even: score=`76.934`, distance=`0.026222`, query_length=`14`
- trim_start_20pct: score=`71.920`, distance=`0.032962`, query_length=`22`
- trim_end_20pct: score=`84.008`, distance=`0.017426`, query_length=`22`
- middle_60pct: score=`68.390`, distance=`0.037995`, query_length=`16`
...
- trim_end_20pct [target_positive_variant]: score=`84.008`, dtw=`0.004750`, total_dist=`0.017426`, expected=high
- subsample_even [target_positive_variant]: score=`76.934`, dtw=`0.006118`, total_dist=`0.026222`, expected=high
- trim_start_20pct [target_positive_variant]: score=`71.920`, dtw=`0.012788`, total_dist=`0.032962`, expected=high
- middle_60pct [target_positive_variant]: score=`68.390`, dtw=`0.017538`, total_dist=`0.037995`, expected=high
...
- other_demo_jump_sparse [other_demo_action]: score=`0.137`, dtw=`0.102895`, total_dist=`0.659304`, expected=low
- fake_random_landmarks [synthetic_fake_action]: score=`0.122`, dtw=`0.522228`, total_dist=`0.671028`, expected=low
- other_demo_singing_sparse [other_demo_action]: score=`0.039`, dtw=`0.158864`, total_dist=`0.784998`, expected=low
